...
namespace VWeaponEditor.Shortcuts {
    public class WPFShortcutManager : ShortcutManager {
        ...
        static WPFShortcutManager() {
            ...
            KeyStroke.ReadableKeyCodeProvider = (x) => ((Key) x).ToString();
            KeyStroke.ReadableModifierProvider = (x, s) => {
            ...
            MouseStroke.ReadableMouseButtonProvider = (x) => {
                switch (x) {
                    ...
                    case 3: return "X1";
                    case 4: return "X2";
                    case BUTTON_WHEEL_UP:   return "Wheel Up";
                    case BUTTON_WHEEL_DOWN: return "Wheel Down";
